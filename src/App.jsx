      ...
      <div className="border border-gray-300  bg-indigo-50 rounded-3xl pt-16 pb-24">
        ...
        <div className="grid grid-cols-2 m-10 px-32 gap-14">
          ...
          <div className="border border-indigo-100 rounded-3xl bg-slate-50">
            <img className="pt-5 p-5" src="/person.png" alt="person" />
          ...
          <div className="border border-indigo-100 rounded-3xl bg-slate-50">
            <img className="pt-5 p-5" src="/ai.png" alt="ai" />
        ...
        <div className="mx-40 rounded-3xl border border-indigo-100 bg-slate-50 pb-10">
          ...
          <div className="grid grid-cols-2 px-10 gap-14">
            ...
            <div className="">
              <img className="pt-5 " src="/security.png" alt="" />
  ...
  return (
    <>
      <div className=" m-10 text-center text-gray-900 p-20">
        ...
        <img className="flex justify-start" src="/tech.png" alt="tech" />
  ...
  return (
    <>
      <div className="  flex bg-indigo-100 " >
        ...
        <ul className="flex justify-center font-bold text-gray-700 py-6 mx-auto">
          <li className="pr-16">Products</li>
          <li className="pr-16">Developers</li>
          <li className="pr-16">Events</li>
          <li className="pr-16">Blog</li>
